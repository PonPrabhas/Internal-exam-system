...
urlpatterns = [
    ...
    path('upload-syllabus/', views.upload_syllabus, name='admin-upload-syllabus'),
    path("admin-upload-academic-calendar/", views.upload_academic_calendar, name="admin-upload-academic-calendar"),
